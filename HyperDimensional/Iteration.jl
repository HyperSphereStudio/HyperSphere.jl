...
export hditer, uhditer, flatten_uhditer, flatten_hditer, total_count, buffer_remove_dimension_parts, sum_comb, unflatten_uhditer, unflatten_hditer, partition, partition_test, partition
...
"""
function buffer_remove_dimension_parts(array::AbstractArray{T, N}, removable_parts, true_array_len) where T where N
